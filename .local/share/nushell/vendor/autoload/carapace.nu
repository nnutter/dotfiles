$env.PATH = ($env.PATH | split row (char esep) | where { $in != "/Users/nnutter/Library/Application Support/carapace/bin" } | prepend "/Users/nnutter/Library/Application Support/carapace/bin")
