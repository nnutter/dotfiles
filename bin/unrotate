#!/bin/bash
# 
# Developed by Fred Weinhaus 12/12/2007 .......... revised 4/30/2013
#
# ------------------------------------------------------------------------------
# 
# Licensing:
...
trap "rm -f $tmpA $tmpB $tmp0 $tmp0a $tmp1 $tmp1a $tmp2 $tmp2a $tmp3 $tmp3a;" 0
trap "rm -f $tmpA $tmpB $tmp0 $tmp0a $tmp1 $tmp1a $tmp2 $tmp2a $tmp3 $tmp3a; exit 1" 1 2 3 15
